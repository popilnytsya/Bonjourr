...
export const dict = {
	...
	'Love using Bonjourr? Consider giving us a review or donating, that would help a lot! 😇': {
		...
		uk: 'Подобається Bonjourr? Залиште відгук або підтримайте нас копієчкою, це дуже нам допоможе! 😇',
	...
	'Icon must be < 8kB': {
		...
		hu: 'Az ikon mérete kissebb kell legyen mint 8kB',
	},
	General: {
		fr: 'Général',
		sv: 'Allmän',
	...
	'The icon and title that appear on your tab. You can put any emoji.': {
		...
		uk: 'Значок та назва, які відображаються на вашій вкладці. Ви можете поставити будь-який емодзі.😉',
	...
	"These are Bonjourr's bookmarks. ": {
		...
		uk: 'Це панель закладок Bonjourr. ',
	...
	'Type the collection ID from its URL, add more by separating them with a comma.': {
		...
		zh_HK: '從其 URL 中输入集錦 ID. 可以通過逗號分隔來添加多個.',
	...
	'Transfer your settings between multiple instances of Bonjourr.': {
		...
		uk: 'Переносьте налаштування між декількома екземплярами Bonjourr.',
